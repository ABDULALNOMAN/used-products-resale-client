...
const Myproductsitem = ({ product }) => {
    console.log(product)
    const { categroy, date, description, image, status, location, name, customerInfo, seller_email, resale } = product
    ...
    return (
        <div>
            <div className="flex flex-row bg-base-100 shadow-xl h-full p-3 relative rounded-md">
                ...
                <div className="w-2/3 ml-4">
                    ...
                    <div className="flex flex-row bottom-4 absolute right-3">
                        <button className="btn btn-warning btn-sm border-none text-gray-300 mr-4">delete</button>
